...
def plot_scaling_energy_per_go(rapl_csv):
    ...
    plt.savefig('analysis/scaling_energy_per_go_scenarios.png', dpi=300, bbox_inches='tight')
    print("[SUCCESS] Plot generated: analysis/scaling_energy_per_go_scenarios.png")
